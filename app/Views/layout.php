...
<head>
    ...
    <title><?= $title ?></title>
    <link rel="icon" href="<?= base_url('template/') ?>/img/Logo.png" type="image/x-icon">
        ...
        <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center mt-2 mb-2" href="/">
                <div class="sidebar-brand-icon rotate-n-0">
                    <!-- <i class="fas fa-laugh-wink"></i> -->
                     <img src="<?= base_url('template'); ?>/img/Logo.png" style="width: 60px; height: 60px;">
                </div>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/tampilData">SD</a>
                        <a class="collapse-item" href="/tampilData/SMP">SMP</a>
                        <a class="collapse-item" href="/tampilData/SMA">SMA</a>
                        <h6 class="collapse-header">Data Karyawan</h6>
                        <a class="collapse-item" href="/tampilData/guru">Guru</a>
                        <a class="collapse-item" href="/tampilData/staffTU">Staff TU</a>
                        <a class="collapse-item" href="/tampilData/amil">Amil</a>
                        <h6 class="collapse-header">Data Users</h6>
                        <a class="collapse-item" href="#">UserApps</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseUtilities"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="16" fill="currentColor" class="bi bi-clipboard-check-fill" viewBox="0 0 16 16">
            ...
            <!-- Nav Item - Pages Collapse Menu -->
             <!-- TAHFIDZ -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTahfidz"
                    aria-expanded="false" aria-controls="collapseTahfidz">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="currentColor" class="bi bi-book-half" viewBox="0 0 16 16">
                        <path d="M8.5 2.687c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783"/>
                    </svg>
                    <span>Bagian Tahfidz</span>
                </a>
            ...
            <!-- KESANTRIAN -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseKesantrian"
                    aria-expanded="false" aria-controls="collapseKesantrian">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="currentColor" class="bi bi-house-gear-fill" viewBox="0 0 16 16">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="currentColor" class="bi bi-shop" viewBox="0 0 16 16">
